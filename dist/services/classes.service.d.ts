...
export declare class ClassesService {
    ...
    upsert(upsertClassDto: ClassInput): Promise<IClass>;
    findAll(filter: Partial<ClassFilterInput>): Promise<IClass[]>;
    findOne(filter: Partial<ClassFilterInput>): Promise<IClass>;
}
